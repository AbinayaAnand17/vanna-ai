# Contributing to Sonline

Thank you for your interest in contributing to Sonline! This guide will help you get started with contributing to the Sonline 2.0+ codebase.
...
2. Clone your fork locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/Sonline.git
   cd Sonline
   ```

3. Add the upstream repository:
   ```bash
   git remote add upstream https://github.com/Sonline-ai/Sonline.git
   ```
...
```bash
# Check formatting
ruff format --check src/Sonline/ tests/

# Apply formatting
ruff format src/Sonline/ tests/

# Run linting
ruff check src/Sonline/ tests/
```
...
if TYPE_CHECKING:
    from Sonline.core.user import User
...
Sonline 2.0+ is built around several key abstractions:

#### 1. **Agent** (`Sonline.core.agent`)
The main orchestrator that coordinates tools, memory, and LLM interactions.

#### 2. **Tools** (`Sonline.tools`, `Sonline.core.tool`)
...
1. **Create the tool class** in `src/Sonline/tools/`:
...
1. **Implement SqlRunner** in `src/Sonline/integrations/mydb/`:

```python
from Sonline.capabilities.sql_runner import SqlRunner, RunSqlToolArgs
from Sonline.core.tool import ToolContext
import pandas as pd
...
1. **Implement LlmService** in `src/Sonline/integrations/myllm/`:

```python
from Sonline.core.llm.base import LlmService
from Sonline.core.llm.models import LlmRequest, LlmResponse, LlmStreamChunk
...
1. **Implement AgentMemory** in `src/Sonline/integrations/mystore/`:

```python
from Sonline.capabilities.agent_memory import (
    AgentMemory,
    ToolMemory,
...
If you're working on legacy SonlineBase compatibility:

- The `LegacySonlineAdapter` bridges legacy code with Sonline 2.0+
- Add tests to `tests/test_legacy_adapter.py`
- See `src/Sonline/legacy/adapter.py` for examples

---

## Getting Help

- **Documentation**: https://Sonline.ai/docs/
- **GitHub Issues**: https://github.com/Sonline-ai/Sonline/issues
- **Discussions**: https://github.com/Sonline-ai/Sonline/discussions

---

## License

By contributing to Sonline, you agree that your contributions will be licensed under the MIT License.

---

Thank you for contributing to Sonline! 🎉
