# Sonline 2.0: Turn Questions into Data Insights
...
![Sonline2 Demo](img/architecture.png)
...
🎨 **Modern Web Interface** — Beautiful pre-built `<Sonline-chat>` component
...
[Quickstart](https://Sonline.ai/docs/quick-start)

### Configure

[Configure](https://Sonline.ai/docs/configure)

### Web Component

```html
<!-- Drop into any existing webpage -->
<script src="https://img.Sonline.ai/Sonline-components.js"></script>
<Sonline-chat
...
**Pre-built `<Sonline-chat>` component** — No need to build your own chat interface
...
![Sonline2 Diagram](img/Sonline2.svg)
...
sequenceDiagram
    ...
    participant W as 🌐 <Sonline-chat>
    participant S as 🐍 Your Server
    participant A as 🤖 Agent
    participant T as 🧰 Tools

    U->>W: "Show Q4 sales"
    W->>S: POST /api/Sonline/v2/chat_sse (with auth)
...
4. **Built-in Web UI** — Pre-built `<Sonline-chat>` component renders everything beautifully

---

## Production Setup with Your Auth

Here's a complete example integrating Sonline with your existing FastAPI app and authentication:

```python
from fastapi import FastAPI
from Sonline import Agent
from Sonline.servers.fastapi.routes import register_chat_routes
from Sonline.servers.base import ChatHandler
from Sonline.core.user import UserResolver, User, RequestContext
from Sonline.integrations.anthropic import AnthropicLlmService
from Sonline.tools import RunSqlTool
from Sonline.integrations.sqlite import SqliteRunner
from Sonline.core.registry import ToolRegistry
...
# 3. Add Sonline routes to your app
chat_handler = ChatHandler(agent)
register_chat_routes(app, chat_handler)

# Now you have:
# - POST /api/Sonline/v2/chat_sse (streaming endpoint)
# - GET / (optional web UI)
```

**Then in your frontend:**
```html
<Sonline-chat sse-endpoint="/api/Sonline/v2/chat_sse"></Sonline-chat>
```

See [Full Documentation](https://Sonline.ai/docs) for custom tools, lifecycle hooks, and advanced configuration

---

## Custom Tools

Extend Sonline with custom tools for your specific use case:

```python
from Sonline.core.tool import Tool, ToolContext, ToolResult
...
Sonline 2.0 includes powerful enterprise features for production use:
...
- 📖 **[Full Documentation](https://Sonline.ai/docs)** — Complete guides and API reference
- 💡 **[GitHub Discussions](https://github.com/Sonline-ai/Sonline/discussions)** — Feature requests and Q&A
- 🐛 **[GitHub Issues](https://github.com/Sonline-ai/Sonline/issues)** — Bug reports
- 📧 **Enterprise Support** — support@Sonline.ai

---

## Migration Notes

**Upgrading from Sonline 0.x?**

Sonline 2.0 is a complete rewrite focused on user-aware agents and production deployments. Key changes:

- **New API**: Agent-based instead of `SonlineBase` class methods
- **User-aware**: Every component now knows the user identity
- **Streaming**: Rich UI components instead of text/dataframes
- **Web-first**: Built-in `<Sonline-chat>` component and server

**Migration path:**

1. **Quick wrap** — Use `LegacySonlineAdapter` to wrap your existing Sonline 0.x instance and get the new web UI immediately
...
**Built with ❤️ by the Sonline team** | [Website](https://Sonline.ai) | [Docs](https://Sonline.ai/docs) | [Discussions](https://github.com/Sonline-ai/Sonline/discussions)
